...
class FluxKontextPipeline(
    ...
    def __call__(
        ...
        if image_ids is not None:
            ...
            print("latent_ids_shape_after_concat:", latent_ids.shape)
        # 5. Prepare timesteps
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                ref_latents = noise_pred[:, latents.size(1) :]
                ...
                if callback_on_step_end is not None:
                    ...
                    callback_outputs = callback_on_step_end(self, i, t, ref_latents, callback_kwargs)
